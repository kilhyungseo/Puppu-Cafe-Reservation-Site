...
<nav role="navigation">
  <ul id="main-menu">
    ...
    <li><a href="petInfo">PET소개</a>
      <ul id="sub-menu">
        <li><a href="petInfo#tag1" aria-label="subemnu">소형견</a></li>
           
        <li><a href="petInfo#tag2" aria-label="subemnu">중형견</a> </li>
           
        <li><a href="petInfo#tag3" aria-label="subemnu">대형견</a></li>
